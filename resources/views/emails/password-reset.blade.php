...
<head>
    ...
    <title>{{ __('site.email_password_reset_subject') }}</title>
</head>
@php
...
<body style="margin:0;padding:0;background:#f5f3ee;color:#1c1917;font-family:Georgia,'Times New Roman',serif;-webkit-text-size-adjust:100%;text-size-adjust:100%;">
    <span style="display:none!important;visibility:hidden;opacity:0;color:transparent;height:0;width:0;overflow:hidden;mso-hide:all;">
        {{ __('site.email_password_reset_preheader') }}
    </span>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;padding-left:16px;">
                                        ...
                                        <div style="margin-top:6px;color:#f8f7f2;font-size:24px;line-height:1.25;font-weight:700;">{{ __('site.email_password_reset_title') }}</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="background:#ffffff;border-left:1px solid #e7e1d6;border-right:1px solid #e7e1d6;padding:34px 32px 8px 32px;">
                            <div style="display:inline-block;border:1px solid #d8e4ca;border-radius:999px;padding:8px 14px;color:#5f6f52;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;">
                                {{ __('site.email_password_reset_badge') }}
                            </div>

                            <p style="margin:26px 0 0;color:#57534e;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.7;">{{ __('site.email_greeting', ['name' => $displayName]) }}</p>
                            <h1 style="margin:10px 0 0;color:#11100f;font-size:32px;line-height:1.18;font-weight:700;letter-spacing:-0.02em;">{{ __('site.email_password_reset_headline') }}</h1>
                            <p style="margin:18px 0 0;color:#57534e;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.75;">{{ __('site.email_password_reset_message') }}</p>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="border-radius:999px;background:#5f6f52;">
                                        <a href="{{ $resetUrl }}" style="display:inline-block;padding:14px 24px;border-radius:999px;color:#ffffff;text-decoration:none;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;">{{ __('site.email_password_reset_button') }}</a>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:18px 0 0;color:#78716c;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.7;">{{ __('site.email_password_reset_expiry') }}</p>
                            <p style="margin:12px 0 0;color:#78716c;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.7;">{{ __('site.email_password_reset_ignore') }}</p>
                        </td>
                    </tr>

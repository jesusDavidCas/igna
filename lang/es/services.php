...
return [
    ...
    'catalog' => [
        ...
        'ADI' => ['name' => 'Llevar agua potable a cada punto del proyecto', 'description' => 'Organizamos cómo debe distribuirse el agua dentro del edificio, predio o desarrollo para que el suministro sea eficiente, seguro y fácil de mantener.'],
        'ADE' => ['name' => 'Conectar tu proyecto al sistema de agua público', 'description' => 'Te ayudamos a resolver la conexión exterior de agua potable y a preparar una propuesta técnica coherente con el entorno del proyecto.'],
        'SSI' => ['name' => 'Conducir las aguas residuales de forma segura', 'description' => 'Definimos cómo transportar herméticamente las aguas residuales dentro del proyecto para reducir riesgos y dejar una solución técnica clara.'],
        'SSE' => ['name' => 'Establecer la salida externa de aguas residuales', 'description' => 'Apoyamos la ruta exterior para conducir las aguas residuales hacia el punto correspondiente, cumpliendo las normas sanitarias obligatorias.'],
        'SLI' => ['name' => 'Evitar problemas por lluvia dentro del proyecto', 'description' => 'Diseñamos la red de aguas lluvias dentro del proyecto para reducir acumulaciones, daños y riesgos de inundación.'],
        ...
        'FPN' => ['name' => 'Diseñar la red de agua para protección de incendios', 'description' => 'Te ayudamos a definir una solución de agua para protección contra incendios con cálculos, criterios y planos que faciliten la construcción.'],
        'HYD' => ['name' => 'Entender lluvia, caudales y riesgo', 'description' => 'Modelamos las cuencas para que tomes decisiones con mejor información y reduzcas riesgos de subdimensionamiento desde el diseño.'],
        'PTP' => ['name' => 'Preparar una planta o sistema para tratar agua potable', 'description' => 'Te acompañamos en la organización técnica de una planta o sistema de tratamiento para que el agua pueda consumirse con mayor seguridad.'],
        'PTR' => ['name' => 'Estructurar el tratamiento de aguas residuales', 'description' => 'Te ayudamos a estructurar el sistema que trate las aguas residuales antes de descargarlas o reutilizarlas, con una solución técnica de excelente calidad.'],
    ],
];

...
return [
    ...
    'catalog' => [
        ...
        'ADI' => ['name' => 'Bring drinking water to every point in your project', 'description' => 'We organize how water should be distributed inside the building, property, or development so the supply is efficient, safe, and easier to maintain.'],
        'ADE' => ['name' => 'Connect your project to the public water system', 'description' => 'We help solve the exterior drinking water connection and prepare a technical proposal that fits the project surroundings.'],
        'SSI' => ['name' => 'Move wastewater safely through the project', 'description' => 'We define how wastewater should be carried through the project in a sealed, safe way to reduce risk and leave a clear technical solution.'],
        'SSE' => ['name' => 'Set the exterior wastewater discharge route', 'description' => 'We support the exterior route for carrying wastewater to the correct point while meeting mandatory sanitary requirements.'],
        'SLI' => ['name' => 'Avoid rainwater problems inside the project', 'description' => 'We design the stormwater network inside the project to reduce pooling, damage, and flooding risk.'],
        ...
        'FPN' => ['name' => 'Design the water network for fire protection', 'description' => 'We help define a fire protection water solution with calculations, criteria, and plans that make construction easier.'],
        'HYD' => ['name' => 'Understand rainfall, flows, and risk', 'description' => 'We model watersheds so you can make better-informed decisions and reduce undersizing risks from the design stage.'],
        'PTP' => ['name' => 'Prepare a plant or system to treat drinking water', 'description' => 'We support the technical organization of a treatment plant or system so water can be consumed more safely.'],
        'PTR' => ['name' => 'Structure wastewater treatment', 'description' => 'We help structure the system that treats wastewater before discharge or reuse, with a high-quality technical solution.'],
    ],
];
